-- CUSTMIZED. Added listing at top-left corner, toggling by orglendar.toggle()
--
...
function orglendar.show(inc_offset)
   ...
   todo = naughty.notify({ title = "Tasks",
                           text = create_todo(),
                           timeout = 0, hover_timeout = 0.5,
                           screen = mouse.screen,
   })
   org_file = naughty.notify({ title = "todo",
                           text = create_orgfile(),
                           timeout = 0, hover_timeout = 0.5,
                           screen = mouse.screen,
                           position="top_left",
