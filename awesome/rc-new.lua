...
awful.spawn.easy_async("setxkbmap -model pc105 -layout us,ru -option ctrl:nocaps,grp:toggle")
...
orglendar.files = { "/home/USERNAME/tasks.org" }
...
awful.screen.connect_for_each_screen(function(s)
   ...
   --   right_layout_add(baticon, batterywidget)
      right_layout_add(cpuicon, cpuwidget, spr)
      right_layout_add(memicon, memwidget)
   --   right_layout_add(musicwidget.widget, volumewidget)
      right_layout_add(spr, mytextclock, spr)
...
--[[   awful.key({           }, "XF86AudioRaiseVolume", function () vol("up") end,
   ...
   awful.key({           }, "Print", function() awful.spawn("scrot '/home/USERNAME/Pictures/screenshots/%Y-%m-%d-%H-%M-%S.png'") end ,
      {description="screenshot", group="awesome"}),
   awful.key({ "Shift"   }, "Print", function() awful.spawn("scrot -u '/home/USERNAME/Pictures/screenshots/%Y-%m-%d-%H-%M-%S.png'") end ,
      {description="screenshot current window", group="awesome"}),
   awful.key({ modkey    }, "l", function() awful.spawn("dm-tool lock") end ,
      {description="lock the screen", group="awesome"}),
   awful.key({ modkey,   }, "Print", function() awful.spawn("scrot -s '/home/USERNAME/Pictures/screenshots/%Y-%m-%d-%H-%M-%S.png'") end ,
         ...
         awful.prompt.run {
            ...
            exe_callback = function (text)
               awful.spawn.easy_async(
                  "python3 -c \"from math import * ; print(" .. text .. ")\"",
